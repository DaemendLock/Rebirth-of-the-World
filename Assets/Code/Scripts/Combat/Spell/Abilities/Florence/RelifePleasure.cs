...
{
    public BluePotion(Unit owner, Unit caster, OldAbility ability, Dictionary<string, float> data) : base(owner, caster, ability, data)
    {
    }

    public override OldStatsTable Bonuses => new() { HastePercent = 20 };
}

public class RedPotion : Status
{
    public RedPotion(Unit owner, Unit caster, OldAbility ability, Dictionary<string, float> data) : base(owner, caster, ability, data)
    {
    }
...
{
    public PurplePotion(Unit owner, Unit caster, OldAbility ability, Dictionary<string, float> data) : base(owner, caster, ability, data)
    {
    }
