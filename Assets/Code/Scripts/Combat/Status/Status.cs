...
public enum modifierfunction : int {
    ...
    MODIFIER_EVENT_ON_DEATH = 2,
    MODIFIER_EVENT_ON_DAMAGE = 4,
    MODIFIER_EVENT_ON_HEAL = 8,
    MODIFIER_PROPERTY_DAMAGE_RECIVE_PERCENT= 16,
    MODIFIER_PROPERTY_DAMAGE_RECIVE_CONSTAN = 32
}
...
namespace Combat.Status
{
    public abstract class Status
    {
        ...
        private readonly OldAbility _ability;
        ...
        public abstract OldStatsTable Bonuses { get; }

        public Status(Unit owner, Unit caster, OldAbility ability, Dictionary<string, float> data, long affectedEvents = 0)
        {
            _owner = owner;
            _caster = caster;
            _ability = ability;
        ...
        public virtual UnitTargetFlag GetAuraSearchFlags()
        {
            return UnitTargetFlag.NONE;
        }

        public virtual UnitTargetTeam GetAuraSearchTeam()
        {
        ...
        public bool AffectsDamageRecived => (_affectedEvents & ((long) modifierfunction.MODIFIER_PROPERTY_DAMAGE_RECIVE_PERCENT | (long) modifierfunction.MODIFIER_PROPERTY_DAMAGE_RECIVE_CONSTAN)) != 0;
    ...
    public abstract class OvershieldStatus : Status
    {
        ...
        public OvershieldStatus(Unit owner, Unit caster, OldAbility ability, Dictionary<string, float> data, float durability, bool destroyOnBroken) : base(owner, caster, ability, data)
        {
