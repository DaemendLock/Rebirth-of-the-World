...
namespace Test
{
    public class UnitBeh : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                spells.Add(SpellLib.GetSpell(id));
            }

            _unitData.BasicSpells = spells.ToArray();

            _unit = UnitFactory.CreateUnit(_unitData, _team, new Position());
        }
        ...
        private void Update()
        {
            ...
            if (Input.GetKeyDown(_checkButton))
            {
                ...
                Unit target = Core.Engine.Combat.GetTargetFor(_unit, spell);
        ...
        private void AutoAttack()
        {
            ...
            {
                Unit target = Core.Engine.Combat.GetTargetFor(_unit, ability.Spell);
