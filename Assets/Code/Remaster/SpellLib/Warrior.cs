...
namespace Remaster.SpellLib.Warrior
{
    public class DirectHit : Spell
    {
        ...
        private static SpellData _spellData = new SpellData(_id, "", 
            new Abilities.AbilityCost(30, 0),
            TargetTeam.ENEMY,
            2,
            0,
            0,
            ...
            new SpellEffect[]
            {
                ...
                new TriggerSpell(2),
                new ApplyAura(new ModStat(Stats.UnitStat.SPEED, new Constant(-0.15f), true))
            },
    ...
    public class СoncentratedDefense : Spell
    {
        ...
        private static SpellData _spellData = new SpellData(_id, "",
            new Abilities.AbilityCost(0, 70),
            TargetTeam.ALLY,
            0,
            0,
            20,
            ...
            new SpellEffect[]
            {
                new ApplyAura(new ModStat(Stats.UnitStat.BLOCK, new Constant(0.3f), false)),
                new ApplyAura(new ModStat(Stats.UnitStat.PARRY, new Constant(0.1f), true))
            },
            SpellFlags.HASTE_AFFECTS_COOLDOWN,
            typeof(Spell)
            );
    ...
    public class Slash : Spell
    {
        ...
        private static SpellData _spellData = new SpellData(_id, "",
            new Abilities.AbilityCost(60, 0),
            TargetTeam.ENEMY,
            3,
            0,
            10,
    ...
    public class IgnorPain : Spell
    {
        ...
        private static SpellData _spellData = new SpellData(_id, "",
            ...
            new SpellEffect[]
            {
                ...
                new ApplyAura(new ModStat(Stats.UnitStat.ATK, new Constant(0.15f), true))
            },
            SpellFlags.NONE,
            typeof(Spell)
            );
    ...
    public class WillForVictory : Spell
    {
        ...
        private static SpellData _spellData = new SpellData(_id, "",
            ...
            new SpellEffect[]
            {
                new ApplyAura(new ModStat(Stats.UnitStat.DAMAGE_TAKEN, new Constant(-0.3f), true)),
    ...
    public class DirectHit2 : Spell
    {
        ...
        private static SpellData _spellData = new SpellData(_id, "",
            new Abilities.AbilityCost(40, 0),
            TargetTeam.ENEMY,
            2,
            0,
            5,
    ...
    public class СoncentratedWeaknesses : Spell
    {
        ...
        private static SpellData _spellData = new SpellData(_id, "",
            ...
            new SpellEffect[]
            {
                new ApplyAura(new ModStat(Stats.UnitStat.CRIT, new Constant(500), false)),
    ...
    public class Slash2 : CleaveSpell
    {
        ...
        private static SpellData _spellData = new SpellData(_id, "",
            new Abilities.AbilityCost(0, 50),
            TargetTeam.ENEMY,
            3,
            0,
            10,
    ...
    public class Charge2 : Spell
    {
        ...
        private static SpellData _spellData = new SpellData(_id, "",
            ...
            new SpellEffect[]
            {
                new ApplyAura(new ModStat(Stats.UnitStat.SPEED, new Constant(-0.2f), true))
            },
            SpellFlags.NONE,
            typeof(Spell)
            );
