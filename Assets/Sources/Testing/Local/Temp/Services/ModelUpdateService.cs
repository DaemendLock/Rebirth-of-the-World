...
namespace Testing.Local.Temp.Services
{
    ...
    //    }
    //}
    public class ModelUpdateService : ITickable
    {
        ...
        public ModelUpdateService(PrecacheAttributersUseCase updateCombatUseCase, UpdateStatusTimersUseCase updateStatusTimersUseCase, StatusModificationProvider statusModificationProvider, UpdateStatusesUseCases updateStatusesUseCase, UpdateActorsUseCase updateActionUseCase, HandleHitUseCase handleHitUseCase)
        {
