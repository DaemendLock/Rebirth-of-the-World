...
namespace Client.Lobby.Domain.Encounter
{
    [Serializable]
    public class Encounter
    {
        ...
        public class EncounterNpc
        {
            ...
            //    UnitCreationData.ModelData mdata = new(new SpellId[0], stats, new(new(_location.x, _location.y, _location.z), _rotation), _npc.CastResources,
            //        _team);
            //    UnitCreationData.ViewData vdata = new(_state.CharacterId, _state.ViewSet);
            //    UnitCreationData udata = new(index, mdata, vdata, contolGroup);
