...
namespace Client.Combat.Input.Handlers
{
    public class CastInputHandler
    {
        ...
        public CastInputHandler(CombatInput source, Selection.SelectionInfo selectionInfo)
        {
        ...
        private static void CastAbility(Selection.SelectionInfo selection, byte spellSlot)
        {
