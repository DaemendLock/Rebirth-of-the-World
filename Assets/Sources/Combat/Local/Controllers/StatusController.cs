...
namespace Combat.Local.Controllers
{
    public class StatusController
    {
        ...
        public StatusController(StartStatusTimerUseCase startStatusTimerUseCase, StopStatusTimerUseCase stopStatusTimerUseCase, RemoveStatusUseCase removeStatusUseCase)
        {
