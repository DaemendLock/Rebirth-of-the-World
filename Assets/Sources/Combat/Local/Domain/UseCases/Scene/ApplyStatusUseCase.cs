...
namespace Combat.Local.Domain.UseCases
{
    public readonly struct ApplyStatusUseCase
    {
        ...
        public void Execute(ApplStatusDTO data)
        {
            ...
            Status status = _statusFactory.Create(data.StatusName, data.Target, data.InitialDuration, data.InitialStackCount, new(data.Caster, data.Skill));
