...
namespace Core.Combat.Abilities
{
    public class SpellModification
    {
        ...
        public PercentModifiedValue Cooldown;
    ...
    public class SpellValueProvider
    {
        ...
        public float Cooldown => (new PercentModifiedValue(_spell.CastTime, 100) + _modification.Cooldown).CalculatedValue;

        public float GetEffectBonus(int effect) => _modification.EffectsModifications[effect];
